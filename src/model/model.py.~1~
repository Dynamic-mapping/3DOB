...
import 3dob.module.module
from 3dob.util.util import *
...
class Net(object):
    ...
    def __init__(self, sess, args):
        ...
        self.ObjectDetect = module.ObjecDetect
        ...
        # Configre log file
        self.log_dir = or.path.join(args.log_dir, args.method, args.log_name)
    ...
    def _build_model(self, args):
        ...
        # classify
        self.n_cor, self.n_obj = self.ObjectDetect(self.pc, is_train=True, reuse=False)

        # loss for objectdetection
        self.loss_cor = self.lossCross(self.n_cor.outputs, self.d_cor)
        self.loss_obj = self.lossCross(self.n_obj.outputs, self.d_obj)
        self.loss_sum = self.loss_cor + self.loss_obj
